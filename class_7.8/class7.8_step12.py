...
# если текущая длина строки кратна 4, прибавляет справа символ x иначе, если текущая длина строки кратна 5,
# прибавляет справа символ y в противном случае прибавляет слева символ z
